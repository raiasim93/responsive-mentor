...
import image from "../../common/images/pagename/joinCommunity/elccwjjsp2oqatbluvxi.svg"
import {FaGithub } from "react-icons/fa6";
const JoinSection = () => {
    return (
        <section className=" px-[8vw] 2xl:px[18vw] py-[12rem] flex flex-col gap-y-12 justify-center 
                            items-center w-screen text-center bg-cover bg-center bg-no-repeat"
